    ...
    <div className="header__nav">
          <Link to={!user &&"/login"}>
           ...
           <Link to="/checkout">
            ...
            <ShoppingBasketIcon/>
                <span className="header__optionLineTwoheader_basketCount">{basket?.length}</span>
            </div>
            </Link>
    </div>
...
<div className="header2">
    ...
    <h4 className="header2__items1">Todays Deals</h4>
    <h4 className="header2__items2">Mobiles</h4>
    <h4 className="header2__items3">Best Sellers</h4>
    <h4 className="header2__items4">Books</h4>
    <h4 className="header2__items5">Customer Service</h4>
    </div>
</div>
</div> 
